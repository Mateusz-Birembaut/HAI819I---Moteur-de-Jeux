...
glm::mat4 Transform::getLocalModelMatrix(float deltaTime) {
    ...
    const glm::mat4 rotationX = glm::rotate(glm::mat4(1.0f),
                            glm::radians(eulerRot.x),
                            glm::vec3(1.0f, 0.0f, 0.0f));
    const glm::mat4 rotationY = glm::rotate(glm::mat4(1.0f),
                            glm::radians(eulerRot.y),
                            glm::vec3(0.0f, 1.0f, 0.0f));
    const glm::mat4 rotationZ = glm::rotate(glm::mat4(1.0f),
...
bool Transform::needsUpdate() {
    return isDirty || continuouslyRotate.x || continuouslyRotate.y || continuouslyRotate.z;
}